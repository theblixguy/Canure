...
Public Class Sync
    ...
    Private Sub BackgroundWorker1_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        Try
            ...
            If TextBox2.Text = txt.Text Then
                ...
                My.Settings.Upgrade()
                My.Settings.Reload()
                MetroForm.Panel2.BackColor = My.Settings.headerclr
                MetroForm.WebKitBrowser1.Navigate(My.Settings.lastvisitedurl)
            Else
                EnableTextboxes()
    ...
    Private Sub Sync_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles Me.Paint
