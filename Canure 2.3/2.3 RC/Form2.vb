...
Public Class Form2
    ...
    Private Sub Form2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Label7.Text = "Your Unique ID is: " & My.Settings.browserGUID
    End Sub

    Private Sub LinkLabel1_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles LinkLabel1.LinkClicked
        MetroForm.Panel12.Visible = True
        MetroForm.Panel12.BackColor = MetroForm.Panel2.BackColor
        MetroForm.WebBrowser1.Navigate("http://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fgetcanure.com%2F%3Fp%3D918&t=Canure")
        Me.Dispose()
        Form3.Dispose()
    End Sub
End Class