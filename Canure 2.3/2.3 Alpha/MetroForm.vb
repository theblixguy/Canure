...
#End Region
    ...
    Private Sub MetroForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        WebKitBrowser1.UserAgent = "Mozilla/5.0 (Windows; U; Windows NT 6.1; en-US) AppleWebKit/534.13 (KHTML, like Gecko) Canure/2.3.0.3"
...
#End Region
    ...
    '// MD5 Checksums of files - Start
    Private Const WebKitBrowserDLL_Checksum = "4ce45bd3ad9656c0b4ca7c7559626b01"
    ...
    Private Sub BackgroundWorker2_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker2.DoWork
        Dim updater As New Utilities.FTP.FTPclient("host", "username", "password")
        '// Check
    ...
    Private Sub BackgroundWorker3_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker3.DoWork
        ...
        Checksum1 = GetMD5HashFromFile(Application.StartupPath & "/" & "WebKitBrowser.dll")
        If Checksum1 = WebKitBrowserDLL_Checksum Then
            MsgBox("Yeah!")
        Else
            MsgBox("Hawww!")
        End If
    ...
    Protected Function GetMD5HashFromFile(ByVal fileName As String) As String
